...
export const defaultHomeData: HomePageData = {
  ...
  projectsSection: {
    ...
    title: 'PROYECTOS',
    items: [
      { icon: '✈', title: 'Pilatus Porter FAP-331', detail: 'Fuerza Aérea del Perú', gallery: [] },
      { icon: '✈', title: 'Cessna P206 — PNP 251', detail: 'Policía Nacional del Perú', gallery: [] },
      { icon: '🔧', title: 'Reparación Estructural PNP 257', detail: 'Policía Nacional del Perú', gallery: [] },
      { icon: '🏫', title: 'Amazon Flight School', detail: 'Escuela de vuelo', gallery: [] },
      { icon: '🪖', title: 'Ejército del Perú — EP 811', detail: 'Fuerzas Armadas', gallery: [] },
      { icon: '✈', title: 'Aero Andino Survey — Pilatus Porter', detail: 'Aviación civil', gallery: [] },
      { icon: '✈', title: 'Aero Andino Survey — Skymaster', detail: 'Aviación civil', gallery: [] },
      { icon: '✈', title: 'Air Majoro', detail: 'Operador aéreo', gallery: [] },
    ],
